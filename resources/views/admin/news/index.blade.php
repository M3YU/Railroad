                    ...
                    <table id="my-table" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><img src="{{$item->image_url}}" alt="" width="200"></td>
                                <td class="align-middle">
                                    <a href="{{asset(" admin/news/$item->id/edit")}}" class="btn btn-info">Edit</a>
                                    <a type="submit" class="btn btn-danger mr-2 my-1 delete-btn">Delete</a>
                                    <form style="width: 0px; margin: 0;"
                                        action="{{route('news.destroy', ['id' => $item->id])}}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
